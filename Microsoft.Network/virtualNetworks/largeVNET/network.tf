...
resource "azurerm_virtual_network" "vnet" {
  ...
  subnet {
    name           = var.dmz_subnetC_name
    address_prefix = var.dmz_subnetC_range
    security_group = azurerm_network_security_group.dmznsgC.id
  }
  ...
  subnet {
    name           = var.app_subnetC_name
    address_prefix = var.app_subnetC_range
    security_group = azurerm_network_security_group.appnsgC.id
  }
  ...
  subnet {
    name           = var.ins_subnetC_name
    address_prefix = var.ins_subnetC_range
    security_group = azurerm_network_security_group.insnsgC.id
  }
  ...
  subnet {
    name           = var.ad_subnetC_name
    address_prefix = var.ad_subnetC_range
    security_group = azurerm_network_security_group.adnsgC.id
  }
  ...
  subnet {
    name           = var.agw_subnetC_name
    address_prefix = var.agw_subnetC_range
    security_group = azurerm_network_security_group.agwnsgC.id
  }
...
resource "azurerm_network_security_group" "dmznsgC" {
  name                = "${var.dmz_subnetC_name}-NSG"
  location            = var.location
  resource_group_name = azurerm_resource_group.vnet_rsg.name

  tags = {
    Environment = var.environmentC
    BuildBy     = var.buildby
    BuildTicket = var.buildticket
    BuildDate   = replace(substr(timestamp(), 0, 10), "-", "")
  }
  ...
  security_rule {
    ...
    source_port_range          = "*"
    destination_port_range     = "*"
    source_address_prefix      = var.dmz_subnetC_range
    destination_address_prefix = var.dmz_subnetC_range
  }
...
resource "azurerm_network_security_group" "appnsgC" {
  name                = "${var.app_subnetC_name}-NSG"
  location            = var.location
  resource_group_name = azurerm_resource_group.vnet_rsg.name
  ...
  security_rule {
    ...
    source_port_range          = "*"
    destination_port_range     = "*"
    source_address_prefix      = var.app_subnetC_range
    destination_address_prefix = var.app_subnetC_range
  }
...
resource "azurerm_network_security_group" "insnsgC" {
  name                = "${var.ins_subnetC_name}-NSG"
  location            = var.location
  resource_group_name = azurerm_resource_group.vnet_rsg.name
  ...
  security_rule {
    ...
    source_port_range          = "*"
    destination_port_range     = "*"
    source_address_prefix      = var.ins_subnetC_range
    destination_address_prefix = var.ins_subnetC_range
  }
...
resource "azurerm_network_security_group" "adnsgC" {
  name                = "${var.ad_subnetC_name}-NSG"
  location            = var.location
  resource_group_name = azurerm_resource_group.vnet_rsg.name
  ...
  security_rule {
    ...
    source_port_range          = "*"
    destination_port_range     = "*"
    source_address_prefix      = var.ad_subnetC_range
    destination_address_prefix = var.ad_subnetC_range
  }
...
resource "azurerm_network_security_group" "agwnsgC" {
  name                = "${var.agw_subnetC_name}-NSG"
  location            = var.location
  resource_group_name = azurerm_resource_group.vnet_rsg.name
  ...
  security_rule {
    ...
    source_port_range          = "*"
    destination_port_range     = "*"
    source_address_prefix      = var.agw_subnetC_range
    destination_address_prefix = var.agw_subnetC_range
  }
