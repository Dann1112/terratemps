...
variable "dmz_subnetC_name" {
  description = "Name of the dmz subnet"
  default     = "EU2-VNET01-DMZ-DEV"
}

variable "dmz_subnetC_range" {
  description = "IP range for dmz subnet"
  default     = "172.16.199.0/24"
}

variable "app_subnetC_name" {
  description = "Name of the app subnet"
  default     = "EU2-VNET01-APP-DEV"
}

variable "app_subnetC_range" {
  description = "IP range for app subnet"
  default     = "172.16.200.0/24"
}

variable "ins_subnetC_name" {
  description = "Name of the inside subnet"
  default     = "EU2-VNET01-INS-DEV"
}

variable "ins_subnetC_range" {
  description = "IP range for app subnet"
  default     = "172.16.201.0/24"
}

variable "ad_subnetC_name" {
  description = "Name of the ad subnet"
  default     = "EU2-VNET01-AD-DEV"
}

variable "ad_subnetC_range" {
  description = "IP range for ad subnet"
  default     = "172.16.195.80/28"
}

variable "agw_subnetC_name" {
  description = "Name of the app gateway subnet"
  default     = "EU2-VNET01-AGW-DEV"
}

variable "agw_subnetC_range" {
  description = "IP range for app gateway subnet"
  default     = "172.16.195.96/28"
}
